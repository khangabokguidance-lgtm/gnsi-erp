    ...
    <div className="nav-inner">
      ...
      <ul className="nav-links nav-menu-desktop">
        {navCategories.map((cat, idx) => (
          cat.links.length === 1 ? (
            <li key={cat.label}>
              <a href={cat.links[0].href} className="nav-cat-link-flat">

...
export default function LandingPage({ onLogin }) {
  ...
  const tabList = [
    ...
    { id: 'head-institute', label: 'Head of Institute' },
    ...
    { id: 'portal', label: 'Parents Portal' },
...
(async () => {
  ...
  try {
    ...
    if (!videos.length) {
      list.innerHTML = '<p style="color:rgba(230,238,248,.85);font-family:Inter,sans-serif;font-size:.8rem;letter-spacing:.02em;text-transform:uppercase;padding:.5rem 0">Videos coming soon</p>';
      return;
    }
    ...
    <div className="hero-wrap">
      <div>
        ...
        <div className="hero-course-chips">
          <a href="#courses" className="hero-course-chip">

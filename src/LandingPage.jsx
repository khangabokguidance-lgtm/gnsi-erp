...
<>
  ...
  <style
    dangerouslySetInnerHTML={{
      __html:
        "\n/* ═══ NAV DROPDOWN ADD-ON ═══ */\n.nav-menu-desktop{align-items:center}\n.nav-cat{position:relative}\n.nav-cat-btn{display:inline-flex;align-items:center;gap:.35rem;background:transparent;border:none;cursor:pointer;font-family:'Source Sans 3',sans-serif;font-size:.82rem;font-weight:600;letter-spacing:.02em;color:var(--cream);padding:.5rem .6rem;border-radius:.35rem;transition:background .2s ease,color .2s ease}\n.nav-cat-btn:hover,.nav-cat-btn.active{background:rgba(184,153,104,.12);color:var(--gold)}\n.nav-cat-arrow{font-size:.6rem;transition:transform .2s ease}\n.nav-cat-btn.active .nav-cat-arrow{transform:rotate(180deg)}\n.nav-cat-dropdown{position:absolute;top:calc(100% + 6px);left:0;min-width:210px;background:var(--navy2);border:1px solid rgba(184,153,104,.25);border-radius:.5rem;box-shadow:0 10px 30px rgba(0,0,0,.35);padding:.4rem;z-index:200;animation:navDropIn .15s ease-out}\n@keyframes navDropIn{from{opacity:0;transform:translateY(-6px)}to{opacity:1;transform:translateY(0)}}\n.nav-cat-link{display:block;padding:.55rem .75rem;font-family:'Source Sans 3',sans-serif;font-size:.8rem;color:var(--cream);text-decoration:none;border-radius:.35rem;border-left:2px solid transparent;transition:background .15s ease,color .15s ease,border-color .15s ease}\n.nav-cat-link:hover{background:rgba(184,153,104,.15);color:var(--gold);border-left-color:var(--gold)}\n.mob-cat{border-bottom:1px solid rgba(184,153,104,.12)}\n.mob-cat-btn{width:100%;display:flex;align-items:center;justify-content:space-between;background:transparent;border:none;cursor:pointer;padding:.85rem .25rem;font-family:'Source Sans 3',sans-serif;font-size:.92rem;font-weight:600;color:var(--cream)}\n.mob-cat-btn.expanded{color:var(--gold)}\n.mob-cat-arrow{font-size:.7rem;transition:transform .2s ease}\n.mob-cat-btn.expanded .mob-cat-arrow{transform:rotate(180deg)}\n.mob-cat-links{display:flex;flex-direction:column;gap:.15rem;padding:.25rem 0 .75rem .75rem;border-left:2px solid rgba(184,153,104,.3);margin-left:.25rem}\n.mob-sub-link{padding:.55rem .6rem;font-family:'Source Sans 3',sans-serif;font-size:.82rem;color:rgba(248,243,232,.85);text-decoration:none;border-radius:.3rem}\n.mob-sub-link:active{background:rgba(184,153,104,.15);color:var(--gold)}\n If JS fails, show content after 3 seconds */\n@media (prefers-reduced-motion: no-preference) {\n  .reveal, .reveal-left, .reveal-right, .reveal-scale {\n    animation: forceVisible 0.1s ease 3s forwards;\n  }\n  @keyframes forceVisible {\n    to { opacity: 1; transform: none; }\n  }\n}\n/* Immediate fallback for no-JS */\n.no-js .reveal, .no-js .reveal-left, .no-js .reveal-right, .no-js .reveal-scale {\n  opacity: 1 !important;\n  transform: none !important;\n}\n"
    }}

...
<>
  ...
  <section className="pad" id="gallery">
    <div className="container">
      ...
      {/* Category 1 — Campus & Facilities */}
      <div className="gcat-block reveal">
        <div className="gcat-hd">
          <div className="gcat-title">
            <h3>Campus &amp; Facilities</h3>
            <span className="gcat-count">12 Photos</span>
          </div>
          <button className="gcat-viewall">View all →</button>
        </div>
        <div className="gcat-grid">
          <div className="gph tall" data-icon="🏫">
            <div className="gph-lbl">Main Academic Block</div>
          </div>
          <div className="gph" data-icon="📚">
            <div className="gph-lbl">Library</div>
          </div>
          <div className="gph" data-icon="⚽">
            <div className="gph-lbl">Sports Ground</div>
          </div>
          <div className="gph" data-icon="🌳">
            <div className="gph-lbl">Campus Grounds</div>
          </div>
          <div className="gph" data-icon="🛡️">
            <div className="gph-lbl">Front Gate &amp; Entrance</div>
          </div>
        </div>
      </div>

      {/* Category 2 — Classrooms & Academics */}
      <div className="gcat-block reveal">
        <div className="gcat-hd">
          <div className="gcat-title">
            <h3>Classrooms &amp; Academics</h3>
            <span className="gcat-count">15 Photos</span>
          </div>
          <button className="gcat-viewall">View all →</button>
        </div>
        <div className="gcat-grid">
          <div className="gph tall" data-icon="✍️">
            <div className="gph-lbl">Classroom Session</div>
          </div>
          <div className="gph" data-icon="📝">
            <div className="gph-lbl">Mock Test Day</div>
          </div>
          <div className="gph" data-icon="🔬">
            <div className="gph-lbl">Science Lab</div>
          </div>
          <div className="gph" data-icon="🧮">
            <div className="gph-lbl">Doubt Clearing Session</div>
          </div>
          <div className="gph" data-icon="👨‍🏫">
            <div className="gph-lbl">Faculty Teaching</div>
          </div>
        </div>
      </div>

      {/* Category 3 — Hostel Life */}
      <div className="gcat-block reveal">
        <div className="gcat-hd">
          <div className="gcat-title">
            <h3>Hostel Life</h3>
            <span className="gcat-count">10 Photos</span>
          </div>
          <button className="gcat-viewall">View all →</button>
        </div>
        <div className="gcat-grid">
          <div className="gph tall" data-icon="🏠">
            <div className="gph-lbl">Hostel Block</div>
          </div>
          <div className="gph" data-icon="🍽️">
            <div className="gph-lbl">Dining Hall</div>
          </div>
          <div className="gph" data-icon="🌅">
            <div className="gph-lbl">Morning Assembly</div>
          </div>
          <div className="gph" data-icon="📖">
            <div className="gph-lbl">Evening Study Hour</div>
          </div>
          <div className="gph" data-icon="🎯">
            <div className="gph-lbl">Discipline Drill</div>
          </div>
        </div>
      </div>

      {/* Category 4 — Events & Ceremonies */}
      <div className="gcat-block reveal">
        <div className="gcat-hd">
          <div className="gcat-title">
            <h3>Events &amp; Ceremonies</h3>
            <span className="gcat-count">18 Photos</span>
          </div>
          <button className="gcat-viewall">View all →</button>
        </div>
        <div className="gcat-grid">
          <div className="gph tall" data-icon="🎖️">
            <div className="gph-lbl">Award Ceremony</div>
          </div>
          <div className="gph" data-icon="🎉">
            <div className="gph-lbl">10th Anniversary Celebration</div>
          </div>
          <div className="gph" data-icon="🇮🇳">
            <div className="gph-lbl">Republic Day Parade</div>
          </div>
          <div className="gph" data-icon="🎤">
            <div className="gph-lbl">Guest Lecture</div>
          </div>
          <div className="gph" data-icon="🏆">
            <div className="gph-lbl">Topper Felicitation</div>
          </div>
        </div>
      </div>

      {/* Category 5 — Achievements & Awards */}
      <div className="gcat-block reveal">
        <div className="gcat-hd">
          <div className="gcat-title">
            <h3>Achievements &amp; Awards</h3>
            <span className="gcat-count">9 Photos</span>
          </div>
          <button className="gcat-viewall">View all →</button>
        </div>
        <div className="gcat-grid">
          <div className="gph tall" data-icon="🏅">
            <div className="gph-lbl">Sainik School Selection 2026</div>
          </div>
          <div className="gph" data-icon="📜">
            <div className="gph-lbl">Institute Certificate of Excellence</div>
          </div>
          <div className="gph" data-icon="🥇">
            <div className="gph-lbl">RMS Rank Holders</div>
          </div>
          <div className="gph" data-icon="🎓">
            <div className="gph-lbl">Navodaya Batch Success</div>
          </div>
          <div className="gph" data-icon="🖼️">
            <div className="gph-lbl">Founder with Toppers</div>
          </div>
        </div>
      </div>

...
<>
  ...
  {/* Head of the Institute */}
  <section className="pad" id="Head of the Institute">
    <div className="container Head of the Institute-grid">
      <div className="reveal-left">
        <div className="Head of the Institute-img">
          {FOUNDER_PHOTO_URL ? (
            <img
          ...
          <div className="Head of the Institute-img-badge">
      ...
      <div className="reveal-right">
        ...
        <blockquote className="Head of the Institute-quote">
        ...
        <div className="Head of the Institute-sig">

...
window.submitGrievance = async () => {
  ...
  try {
    ...
    // Fallback max-marks config, only used if no exam_schedule / course_subjects
    // config is found for this course + exam (mirrors Exams.jsx COURSE_MAX_MARKS)
...
.logo-ring{width:64px;height:64px;border-radius:50%;border:2px solid #D4A017;background:rgba(255,255,255,0.08);display:flex;align-items:center;justify-content:center;flex-shrink:0;overflow:hidden;}
...
`;
    ...
    function buildRCHTML(st, subjects, subjectMaxMap, courseMax, marksMap, allStudents, examName, examDate, institute, remarkText) {
      ...
      return `<div class="card">
        ...
        <div class="header">
          <div class="logo-ring"><img src="${institute.logoUrl || EMBLEM_URL}" onerror="this.parentElement.innerHTML='<div class=&quot;logo-text&quot;>GNSI</div>'"/></div>
          <div class="header-center">
            <div class="eyebrow">Official Academic Record · ${institute.academicYear || "2026-2027"}</div>
        ...
        <div class="exam-result-bar">
          <div class="exam-info">
            ...
            <div class="exam-info-item"><span class="exam-info-label">Academic Year</span><span class="exam-info-value">${institute.academicYear || "2026-2027"}</span></div>
          ...
          <div class="result-pill-bar">
            <span style="font-size:20px;font-weight:700;color:${grade.color}">${grade.label}</span>
        ...
        <div class="student-section">
          ...
          <table class="student-table">
            ...
            <tr><td class="lbl">Course</td><td class="val">${st.course || "—"}</td><td class="lbl">Batch</td><td class="val">${st.class_name || "—"}</td></tr>
          </table>
        </div>
        <div class="score-grid" style="margin:0 16px;">
          ...
          <div class="score-cell"><div class="score-lbl">Grade</div><div class="score-val" style="color:${grade.color}">${grade.label}</div><div class="score-sub">${grade.gpa.toFixed(1)} GPA</div></div>
        ...
        <div class="marks-section">
          ...
          <table class="marks-table">
            ...
            <tfoot><tr>
              ...
              <td><div style="display:flex;align-items:center;gap:5px;"><div style="flex:1;height:7px;background:#E2E8F0;border-radius:3px;overflow:hidden;"><div style="width:${pct}%;height:100%;background:${grade.color};border-radius:3px;"></div></div><span style="font-size:11px;font-weight:700;color:${grade.color}">${pct.toFixed(1)}%</span></div></td>
              <td><span style="display:inline-block;padding:2px 9px;border-radius:2px;font-size:12px;font-weight:700;color:${grade.color};border:1px solid ${grade.color};background:${grade.color}18">${grade.label}</span></td>
        ...
        <div class="footer-strip"><div class="footer-text">${institute.name || "GNSI"} · ${institute.address || "Khangabok, Manipur"} · ${examName} · Academic Year ${institute.academicYear || "2026-2027"}</div></div>
    ...
    window.ppPrintReportCard = async () => {
      ...
      try {
        ...
        // Subjects & max marks: prefer the live exam_schedule for this course + exam
        // (authoritative — mirrors what the Exams module actually used), otherwise
        // fall back to the saved course_subjects config, then to the static defaults.
        ...
        // Classmates in the same batch, for rank calculation

...
(async () => {
  ...
  try {
    ...
    if (!videos.length) {
      list.innerHTML = '<p style="color:rgba(248,243,232,.70);font-family:\'Rajdhani\',sans-serif;font-size:.8rem;letter-spacing:.06em;text-transform:uppercase;padding:.5rem 0">Videos coming soon</p>';
      return;
    }
...
<>
  ...
  <div id="stickyBar">
    <p>
      ⚑ Admissions 2026–27 are open — <strong>Limited seats remaining.</strong>{" "}
    ...
    <div className="sticky-btns">
      ...
      <a
        href="https://wa.me/918974298074?text=Hello%20GNSI%2C%20I%20am%20interested%20in%20admissions%20for%202026%E2%80%9327."
  ...
  {/* ALERT */}
  <div className="alert-strip" id="alertbar">
    <span>
    ...
    <div className="ticker-inner">
      ...
      <div className="ticker-scroll">
        <div className="ticker-track">
          ADMISSIONS OPEN 2026–27 ◆ RESULT: 66 SELECTED IN NVS &amp; SAINIK
          ...
          KHANGABOK, THOUBAL, MANIPUR &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ADMISSIONS
          OPEN 2026–27 ◆ RESULT: 66 SELECTED IN NVS &amp; SAINIK SCHOOL 2025–26
  ...
  <div className="countdown-bar">
    <div className="countdown-label">Admissions close in</div>
  ...
  <div className="result-banner" id="resultBanner">
    <div className="result-banner-track" id="rbTrack">
      {/* Slide 1 */}
      <div className="result-banner-slide">
        <img
      ...
      >
        <div
          ...
          style={{
            background:
              "linear-gradient(90deg,rgba(11,31,58,.98),rgba(11,31,58,.7))"
          }}
        >
          <div className="result-banner-content">
            <div className="result-banner-year">🎯 Admissions Open 2026–27</div>
            <div className="result-banner-title">
              Join GNSI — <strong>Limited Seats</strong> Remaining
            </div>
            <div className="result-banner-sub">
              Apply before 30 June 2026 · Hostel &amp; Day Scholar options ·
              Call +91 89742 98074
            </div>
          </div>
        </div>
  ...
  <nav>
    <div className="nav-inner">
      ...
      <ul className="nav-links">
        ...
        <li>
          <a href="#scholarship">Free Test</a>
        </li>
        <li>
          <a href="#question-papers">Papers</a>
        </li>
        <li>
          <a href="#exam-calendar">Calendar</a>
        </li>
        <li>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: ".5rem" }}>
        <button className="hamburger" id="hbg">
          <span />
          <span />
          <span />
        </button>
  ...
  <div className="mob-menu" id="mobMenu">
    <div className="mob-menu-hd">
      <div className="mob-menu-brand">
        <div className="crest" style={{ width: 32, height: 32 }}>
          <div className="crest-i" style={{ width: 22, height: 22, fontSize: ".7rem" }}>G</div>
        </div>
        <span>GNSI</span>
      </div>
      <button className="mob-menu-close" onClick={() => window.closeMob()} aria-label="Close menu">
        ✕
      </button>
    </div>
    <div className="mob-menu-scroll">
      ...
      <a
        href="#"
        onClick={(e) => { e.preventDefault(); window.openPP(); window.closeMob(); }}
        className="mob-par"
      >
        Parents Portal →
      </a>
    ...
    <div className="mob-menu-bottom">
      <a href="#fee-payment" onClick={() => window.closeMob()} className="mmb-fee">
        💳 Pay Fee
      </a>
      <a href="#enquiry" onClick={() => window.closeMob()} className="mmb-apply">
        Apply Now →
      </a>
    </div>
  </div>
  ...
  <section className="hero">
    ...
    <div className="hero-wrap">
      <div>
        ...
        <div className="hero-eyebrow">Admissions Open · 2026–27</div>
        <h1>
          <em>
    ...
    <div className="pp-login-wrap" id="ppLoginWrap">
      ...
      <div className="pp-box">
        <div className="pp-logo">
          <div
            className="crest"
            style={{ width: 56, height: 56, margin: "0 auto .8rem" }}
          >
            <div
              className="crest-i"
    ...
    <div className="pp-shell" id="ppShell">
      <div className="pp-topbar">
        <div className="pp-topbar-l">
          <div className="crest" style={{ width: 34, height: 34 }}>
            <div
              className="crest-i"
              style={{ width: 24, height: 24, fontSize: ".8rem" }}
            >
              G
            </div>
          </div>

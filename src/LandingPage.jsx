...
<>
  ...
  <section className="mocktest-section" id="mock-tests">
    <div className="container">
      ...
      <h2 className="st reveal" style={{ color: "#F0F0F0" }}>
    ...
    <div className="container enquiry-grid">
      <div>
        ...
        <div className="form-panel reveal">
          ...
          >
            Or call us directly:{" "}
            <a href="tel:+918974298074" style={{ color: "#F0F0F0", textDecoration: "underline" }}>
              +91 89742 98074
            </a>
          </p>
        </div>
